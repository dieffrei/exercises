...
public class ExerciseEightHundred extends ExerciseEightExpression {
		
		private ExerciseEightExpression ex = new ExerciseEightTen();
		...
		public String interpret(String number){
			...
			// verifica se o n�mero possui pelo menos 3 casas
			if (number.length() < 3){
				// se o n�mero possuir menos de 3 casas passe para a classe Dezena avaliar.
				...
				if (this.left(number,3).equals("100")){
					...
					// pega o lado remanescente do n�mero Ex: 1(23) --> 23
